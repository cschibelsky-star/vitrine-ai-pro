...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->renderHook(
                'panels::head.end',
                fn (): string => '<link rel="stylesheet" href="' . asset('css/vitrine-enterprise-ui.css') . '?v=10.0.2"><link rel="stylesheet" href="' . asset('css/vitrine-enterprise-overrides.css') . '?v=10.0.3"><link rel="stylesheet" href="' . asset('css/via-factory.css') . '?v=1.0.0">'
            )
            ->renderHook(
                'panels::body.end',
