...
{
    protected $signature = 'factory:learn-module {slug : Slug do módulo gerado} {--system= : Slug do sistema para builds namespaced}';
    ...
    {
        try {
            $result = $learning->learn((string) $this->argument('slug'), (string) ($this->option('system') ?? ''));
