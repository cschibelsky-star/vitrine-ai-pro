...
use App\Filament\Resources\FinanceiroResource\Pages\EditFinanceiro;
use App\Filament\Resources\FinanceiroResource\Pages\ListFinanceiros;
use App\Filament\Resources\FinanceiroResource\Pages\ViewFinanceiro;
...
class FinanceiroResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'Blueprint: Financeiro';
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Section::make('Dados principais')->schema([
                    ...
                    TextInput::make('descricao')->label('Descricao')->maxLength(255),
                    TextInput::make('valor')->label('Valor')->numeric(),
                    DatePicker::make('vencimento')->label('Vencimento'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('vencimento')->label('Vencimento')->searchable()->sortable(),
