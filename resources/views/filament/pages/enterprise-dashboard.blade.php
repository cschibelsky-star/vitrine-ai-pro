<x-filament-panels::page>
    ...
    <div class="space-y-8">
        ...
        <section class="vip-hero vip-grid-bg relative overflow-hidden rounded-[2rem] p-8 text-white shadow-2xl ring-1 ring-white/10">
            <div class="relative z-10 grid gap-10 lg:grid-cols-[1.3fr_.7fr] lg:items-center">
                <div>
                    ...
                    <div class="mt-8 flex flex-wrap gap-3">
                        <a href="/admin/factory-studio-enterprise" class="rounded-2xl bg-sky-500 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-sky-500/25 hover:bg-sky-400">
                            Abrir Factory Studio
                        </a>
                        <a href="/admin/generated-projects" class="rounded-2xl border border-white/15 bg-white/10 px-5 py-3 text-sm font-bold text-white hover:bg-white/15">
                            Projetos Gerados
                        </a>
                        <a href="/admin/marketplace-enterprise" class="rounded-2xl border border-white/15 bg-white/10 px-5 py-3 text-sm font-bold text-white hover:bg-white/15">
                            Marketplace
                        </a>
                    </div>
                </div>
        ...
        <section class="grid gap-5 md:grid-cols-4">
            @foreach ([
                ...
                ['label' => 'Release', 'value' => 'RC2', 'desc' => 'Enterprise 6.0'],
            ] as $card)
                    ...
                    @foreach ($this->getProducts() as $product)
                        <div class="rounded-[1.25rem] border border-slate-200 bg-slate-50 p-5 dark:border-slate-800 dark:bg-slate-950">
                            <div class="flex items-start justify-between gap-4">
                                ...
                                <span class="rounded-full bg-white px-3 py-1 text-xs font-bold text-slate-600 ring-1 ring-slate-200 dark:bg-slate-900 dark:text-slate-300 dark:ring-slate-700">
                                    {{ $product['status'] }}
                                </span>
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-[1.5rem] border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    ...
                    <p class="mt-2 text-sm leading-6 text-slate-500 dark:text-slate-400">
                        Conectar formulário/checkout do site comercial ao intake automático da Factory.
                    </p>
                </div>
            </div>
        </section>
